export const PROJECTS = [
  {
    ...
    link: "https://sunny-froyo-2942d8.netlify.app",
    repo: "https://github.com/Bebe-dev/Weather-App",
    description: "A real time weather tracking application",
    technologies: ["React", "Tailwind CSS", "Axios", "OpenWeather API"],
  },
  {
    title: "CharitFix",
  ...
  },
  {
    ...
    link: "https://to-do-six-lac.vercel.app/",
    repo: "https://github.com/Bebe-dev/ToDo",
    description: "A simple to-do list application",
    technologies: ["React", "Tailwind CSS", "TypeScript", "Redux"],
  },
  {
    title: "Erasmus Housing",
